...
import { registerContextCli } from "../context-cli.js";
import { registerMcpBrowserCommand } from "../mcp-browser-cli.js";
...
export const commandRegistry: CommandRegistration[] = [
  ...
  {
    id: "context",
    register: ({ program }) => registerContextCli(program),
  },
  {
    id: "agent",
  ...
  {
    id: "mcp-browser",
    register: ({ program }) => registerMcpBrowserCommand(program),
  },
];
