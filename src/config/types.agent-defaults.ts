...
export type AgentDefaultsConfig = {
  ...
  /** Session Brain configuration for cross-session memory. */
  sessionBrain?: {
    /** Enable Session Brain (default: true). */
    enabled?: boolean;
    /** Max brain entries to retain (default: 100). */
    maxEntries?: number;
    /** Inject brain context on session start (default: true). */
    injectOnSessionStart?: boolean;
    /** Update brain on session end (default: true). */
    updateOnSessionEnd?: boolean;
    /** Update brain before compaction (default: true). */
...
export type AgentCompactionConfig = {
  ...
  /** Enable automatic compaction triggers (default: true). */
  auto?: boolean;
  ...
  /** Max number of automatic compactions before the session is considered degraded. */
  maxAutoCompactions?: number;
  /** Compaction count at which to start surfacing degradation warnings. */
